  ...
  return (
      <Card className="d-flex flex-row flex-wrap mb-5" style={{ width: "20rem" }}>
        ...
        <Card.Body className="d-flex flex-column">
          ...
          <Card.Title className="mb-0 font-weight-bold">{card.title}</Card.Title>
          <Badge pill className="mb-2" bg="dark">${card.price}</Badge>
          </div >
          <Card.Text className="text-secondary">{card.description}</Card.Text>
          <Button className="mt-auto font-weight-bold"variant="primary">Add to cart</Button>
        </Card.Body>
      </Card>
  );
}
